...
namespace GarmentFactoryDatabaseImplement
{
    public class GarmentFactoryDatabase : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-H80LAH0\SQLEXPRESS;Initial Catalog=GarmentFactoryDatabase;Integrated Security=True;MultipleActiveResultSets=True;");
            }
        ...
        public virtual DbSet<WarehouseTextile> WarehouseTextiles { get; set; }
    }
}
